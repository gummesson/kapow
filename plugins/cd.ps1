...
Function Set-LocationUpOneStep    { Set-Location ../ }
Function Set-LocationUpTwoSteps   { Set-Location ../../ }
Function Set-LocationUpThreeSteps { Set-Location ../../../ }
Function Set-LocationUpFourSteps  { Set-Location ../../../../ }
Function Set-LocationUpFiveSteps  { Set-Location ../../../../../ }
